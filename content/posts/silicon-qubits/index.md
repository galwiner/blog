...
With manufactured solids we can control our periodic Bloch electrons in more ways. For example, we can make layers of different materials, like a layered cake. This makes the periodicity that the electrons "see" above and below them different to what they see to their sides. Such a situation can make it "easier" for the electrons to flow within a layer than between layers. They end up flowing only in two dimensions and not in the third dimension. This is a useful situation called Two-Dimensional Electron Gas, abbreviated to 2DEG. There are other possibilities for controlling electrons that come about by being able to control the geometry and materials in the manufactured solid.  

## Summary

Our playing field is that of the solid. A periodic set of atoms which make up what is technically known as an atomic lattice. Electrons, which behave as waves and aren't single point particles, can flow through the lattice and interact (interfere). The nature of the interference pattern that emerges is intimately linked to the lattice through which they flow. It becomes periodic itself, to match the period of the lattice. This picture was developed to enable calculations and engineering solutions to control the flow of electrons. 
